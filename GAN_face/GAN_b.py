...
#
# from TESTING_GAN.gan_settings import _IMG_ROWS, _IMG_COLS, _CHANNEL, \
#     _TRAIN_IMG_PATH,\
#     _TRAIN_STEPS,  _BATCH_SIZE, _SAVE_INTERVAL, \
#     _OUTPUT_IMAGES_X, _OUTPUT_IMAGES_Y, \
#     _MOBILENET_INPUT_SHAPE, \
...
class DCGAN(object):
    ...
    def discriminator(self):
        ...
        self.x2 = Dense(512, activation='relu')(self.x1)
        self.x3 = Dense(256, activation='relu')(self.x2)
        self.x4 = Dense(256, activation='sigmoid')(self.x3)
...
class MNIST_DCGAN(object):
    ...
    def train(self, train_steps=_TRAIN_STEPS, batch_size=_BATCH_SIZE, save_interval=_SAVE_INTERVAL):
        ...
        if save_interval>0:
            ...
            noise_input = np.random.uniform(-1.0, 1.0, size=[224,224,3])
        for i in range(train_steps):
            ...
            images_fake = self.generator.predict(noise).reshape(batch_size, _IMG_ROWS, _IMG_COLS, _CHANNEL)
